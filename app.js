...
if (!supportsVideo) {
  alert("Your browser does not support html5 video player");
}
...
const toggleMute = () => {
  ...
  if (video.muted) {
    ...
    fullVolumeButton.style.display = "block";
...
const setPlaybackSpeed = (value) => {
  const prevActivceButton = document.getElementsByClassName(
  ...
  const prevActivceLabel =
    document.getElementsByClassName("speed-label-active")[0];
  if (prevActivceLabel) {
  ...
  if (value === ".5") {
    const playbackButton =
      document.getElementsByClassName("playback-button")[0];
    ...
    const playbackButton =
      document.getElementsByClassName("playback-button")[1];
    playbackButton.classList.add("playback-item-active");
    ...
    const playbackButton =
      document.getElementsByClassName("playback-button")[2];
    playbackButton.classList.add("playback-item-active");
    ...
    const playbackButton =
      document.getElementsByClassName("playback-button")[3];
    playbackButton.classList.add("playback-item-active");
    ...
    const playbackButton =
      document.getElementsByClassName("playback-button")[4];
    playbackButton.classList.add("playback-item-active");
